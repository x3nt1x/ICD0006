...
watch(() => identityStore.JWTResponse, (newJWTResponse) =>
{
    ...
    firstName.value = jwtObject['http://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname'][0];
    lastName.value = jwtObject['http://schemas.xmlsoap.org/ws/2005/05/identity/claims/surname'][0];
});
