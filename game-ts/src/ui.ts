...
export function UI(paused = false, scoreValue: number): HTMLDivElement
{
...
export function addUICar(size: number, position: number): HTMLImageElement
{
...
export function addUIRow(row: Row): HTMLDivElement
{
